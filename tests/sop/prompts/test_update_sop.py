...
class TestUpdateSopPrompt(unittest.TestCase):
    ...
    def test_mentions_range_update_flow(self):
        ...
        via get_sop(id, raw=True), identify the 1-based inclusive range
        ...
        self.assertIn('update(id, type="sop", content, begin=..., end=...)', result)
        ...
        self.assertLess(
            ...
            result.index('update(id, type="sop", content, begin=..., end=...)'),
        )
