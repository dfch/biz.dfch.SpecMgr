...
"""Tests for the `specmgr://gol/example` resource (`gol.resources.gol_example.gol_example`)."""
...
from biz.dfch.specmgr.gol.resources.gol_example import gol_example
from biz.dfch.specmgr.gol.tools.get_gol_example import get_gol_example


class TestGolExampleResource(unittest.TestCase):
    """Tests for the gol_example resource function."""
    ...
    def test_matches_the_get_gol_example_tool(self):
        """The resource and the tool must return identical content -- same underlying reader."""
        self.assertEqual(gol_example(), get_gol_example())
