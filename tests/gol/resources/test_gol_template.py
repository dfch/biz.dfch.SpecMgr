...
"""Tests for the `specmgr://gol/template` resource (`gol.resources.gol_template.gol_template`)."""
...
from biz.dfch.specmgr.gol.resources.gol_template import gol_template
from biz.dfch.specmgr.gol.tools.get_gol_template import get_gol_template


class TestGolTemplateResource(unittest.TestCase):
    """Tests for the gol_template resource function."""
    ...
    def test_returns_real_packaged_template(self):
        ...
        self.assertIn("# Level 1 Heading is the Title of the Goal", result)

    def test_matches_the_get_gol_template_tool(self):
        """The resource and the tool must return identical content -- same underlying reader."""
        self.assertEqual(gol_template(), get_gol_template())
    ...
    def test_reads_fresh_on_every_call(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            template_path = Path(tmp) / "gol_template.md"
