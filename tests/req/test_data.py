...
"""Tests for `req._data.read_req_example_text`/`read_req_template_text` (Tasks 3.6, 3.7)."""
...
from biz.dfch.specmgr.req._data import read_req_example_text, read_req_template_text
