...
"""Tests for the `specmgr://req/example` resource (`req.resources.req_example.req_example`)."""
...
from biz.dfch.specmgr.req.resources.req_example import req_example
from biz.dfch.specmgr.req.tools.get_req_example import get_req_example


class TestReqExampleResource(unittest.TestCase):
    """Tests for the req_example resource function."""
    ...
    def test_matches_the_get_req_example_tool(self):
        """The resource and the tool must return identical content -- same underlying reader."""
        self.assertEqual(req_example(), get_req_example())
