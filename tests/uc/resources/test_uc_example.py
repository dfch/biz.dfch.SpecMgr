...
"""Tests for the `specmgr://uc/example` resource (`uc.resources.uc_example.uc_example`)."""
...
from biz.dfch.specmgr.uc.resources.uc_example import uc_example
from biz.dfch.specmgr.uc.tools.get_uc_example import get_uc_example


class TestUcExampleResource(unittest.TestCase):
    """Tests for the uc_example resource function."""
    ...
    def test_matches_the_get_uc_example_tool(self):
        """The resource and the tool must return identical content -- same underlying reader."""
        self.assertEqual(uc_example(), get_uc_example())
