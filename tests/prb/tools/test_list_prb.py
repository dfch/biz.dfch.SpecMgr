...
class TestListPrb(unittest.TestCase):
    ...
    def test_returns_summaries_and_reports_malformed_file_as_a_failed_entry(self) -> None:
        ...
        broken_path.write_text("not a valid problem statement, no headings at all", encoding="utf-8")
        ...
        self.assertEqual(titles, {"Simple Problem Statement", "Another Problem Statement", "<failed to parse>"})
