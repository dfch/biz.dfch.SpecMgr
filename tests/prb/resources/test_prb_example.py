...
"""Tests for the `specmgr://prb/example` resource (`prb.resources.prb_example.prb_example`)."""
...
from biz.dfch.specmgr.prb.resources.prb_example import prb_example
from biz.dfch.specmgr.prb.tools.get_prb_example import get_prb_example


class TestPrbExampleResource(unittest.TestCase):
    """Tests for the prb_example resource function."""
    ...
    def test_matches_the_get_prb_example_tool(self):
        """The resource and the tool must return identical content -- same underlying reader."""
        self.assertEqual(prb_example(), get_prb_example())
    ...
    def test_reads_fresh_on_every_call(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            example_path = Path(tmp) / "prb_example.md"
