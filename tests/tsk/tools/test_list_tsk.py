...
class TestListTsk(unittest.TestCase):
    ...
    def test_returns_summaries_and_reports_malformed_file_as_a_failed_entry(self) -> None:
        ...
        broken_path.write_text("not a valid task list, no headings at all", encoding="utf-8")
        ...
        self.assertEqual(titles, {"Simple Task List", "Another Task List", "<failed to parse>"})
