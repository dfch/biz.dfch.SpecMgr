...
@mcp.tool(
    name="get_prb_example",
    title="Get PRB example",
    description=(
        "Return a complete, valid sample problem statement document as raw markdown -- "
        "frontmatter and body -- exercising every section, for use as a learning example."
    ),
)
def get_prb_example() -> str:
    ...
    str
        ...
        frontmatter block.
    """
    return read_packaged_text("prb", "example")
