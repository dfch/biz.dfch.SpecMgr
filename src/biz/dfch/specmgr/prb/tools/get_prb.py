...
adapter. The ``.md`` file itself remains the sole source of truth (ADR
...
def get_prb(id: str, raw: bool = False, offset: int | None = None, limit: int | None = None) -> PrbDocument | str:
