...
"""Shared, private constants for the ``vcr.models.v1`` subpackage."""

from __future__ import annotations

#: The generated-schema layout version for ``docs/vcr_schema.json``. Matches
#: this package's own folder name (``vcr/models/v1``) -- bump only when a
...
#: ``commands.schema.generate_vcr_schema()`` as the emitted JSON's
...
#: a bare token (``"v1"``, no ``"vcr "`` prefix) -- the doc type is already
