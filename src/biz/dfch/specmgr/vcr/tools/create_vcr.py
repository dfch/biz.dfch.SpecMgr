...
def create_vcr(content: str) -> VcrFrontmatter:
    ...
    pydantic.ValidationError
        ...
        written.
    """
    with wrap_tool_errors(domain="vcr", tool="create_vcr", channel=BODY_CHANNEL):
    ...
    read_vcr(path)  # warm the cache with this write's own validated content (feat-107-doc-cache Phase 4, REQ-003)
