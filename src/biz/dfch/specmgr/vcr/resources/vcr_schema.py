...
@mcp.resource(
    "specmgr://vcr/schema",
    name="vcr_schema",
    title="Verification Case Record (VCR) JSON Schema",
    description=(
        "The generated VCR JSON Schema (2020-12 dialect), generated by `specmgr schema` and "
...
def vcr_schema() -> dict[str, Any]:
    ...
    """
    result: dict[str, Any] = json.loads(read_packaged_text("vcr", "schema", "json"))
    return result
