...
@mcp.resource(
    ...
    description=(
        "The generated TSK JSON Schema (2020-12 dialect), generated by `specmgr schema` and "
...
def tsk_schema() -> dict[str, Any]:
    ...
    """
    result: dict[str, Any] = json.loads(read_packaged_text("tsk", "schema", "json"))
    return result
