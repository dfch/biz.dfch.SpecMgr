...
@mcp.resource(
    ...
    name="sysrs_schema",
    title="System Requirements Specification (SYSRS) JSON Schema",
    description=(
        "The generated SYSRS JSON Schema (2020-12 dialect), generated by `specmgr schema` and "
...
def sysrs_schema() -> dict[str, Any]:
    ...
    """
    result: dict[str, Any] = json.loads(read_packaged_text("sysrs", "schema", "json"))
    return result
