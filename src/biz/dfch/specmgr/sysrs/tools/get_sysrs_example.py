...
@mcp.tool(
    name="get_sysrs_example",
    title="Get SYSRS example",
    description=(
        "Return a complete, valid sample System Requirements Specification document as raw "
        "markdown -- frontmatter and body -- exercising every section, for use as a learning "
        "example."
    ),
)
def get_sysrs_example() -> str:
