...
@mcp.tool(
    name="get_sysrs_template",
    title="Get SYSRS template",
    description=(
        "Return a SYSRS document template -- frontmatter and every body field present, populated "
