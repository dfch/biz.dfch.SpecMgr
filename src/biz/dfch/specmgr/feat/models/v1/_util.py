...
"""Shared, private constants for the ``feat.models.v1`` subpackage."""

from __future__ import annotations

#: The generated-schema layout version for ``docs/feat_schema.json``. Matches
#: this package's own folder name (``feat/models/v1``) -- bump only when a
...
#: ``commands.schema.generate_feat_schema()`` (Phase 3) as the emitted JSON's
...
#: a bare token (``"v1"``, no ``"feat "`` prefix) -- the doc type is already
