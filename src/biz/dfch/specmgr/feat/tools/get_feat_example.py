...
@mcp.tool(
    name="get_feat_example",
    title="Get FEAT example",
    description=(
        "Return a complete, valid sample feature document as raw markdown -- frontmatter and body "
        "-- exercising every section, for use as a learning example."
    ),
)
def get_feat_example() -> str:
    ...
    str
        ...
        frontmatter block.
    """
    return read_packaged_text("feat", "example")
