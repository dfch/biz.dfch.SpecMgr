...
"""Shared, private constants for the ``qa.models.v2`` subpackage."""

from __future__ import annotations

#: The generated-schema layout version for ``docs/qa_schema.json``. Matches
#: this package's own folder name (``qa/models/v2``) -- bump only when a
...
#: a bare token (``"v2"``, no ``"qa "`` prefix) -- the doc type is already
