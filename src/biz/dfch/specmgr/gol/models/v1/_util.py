...
"""Shared, private constants for the ``gol.models.v1`` subpackage."""

from __future__ import annotations

#: The generated-schema layout version for ``docs/gol_schema.json``. Matches
#: this package's own folder name (``gol/models/v1``) -- bump only when a
...
#: ``commands.schema.generate_gol_schema()`` as the emitted JSON's
...
#: a bare token (``"v1"``, no ``"gol "`` prefix) -- the doc type is already
