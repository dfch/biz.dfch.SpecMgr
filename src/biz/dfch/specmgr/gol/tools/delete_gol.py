...
"""``@mcp.tool()`` wrapper: delete_gol (Task 3.6).

Registered stub only -- reserves the ``delete_gol`` name/slot in the GOL
...
else -- undecided, matching the other five domains' own ``delete_*`` stubs,
...
@mcp.tool(
    name="delete_gol",
    title="Delete goal (not yet implemented)",
...
def delete_gol(id: str) -> NoReturn:
    ...
    NotImplementedError
        Always.
    """
    raise NotImplementedError("delete_gol is not yet implemented")
