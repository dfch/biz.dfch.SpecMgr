...
@mcp.resource(
    ...
    description=(
        "The generated UC JSON Schema (2020-12 dialect), generated by `specmgr schema` and "
...
def uc_schema() -> dict[str, Any]:
    ...
    """
    result: dict[str, Any] = json.loads(read_packaged_text("uc", "schema", "json"))
    return result
