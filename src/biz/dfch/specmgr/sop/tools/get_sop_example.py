...
@mcp.tool(
    name="get_sop_example",
    title="Get SOP example",
    description=(
        "Return a complete, valid sample Standard Operating Procedure document as raw markdown -- frontmatter "
        "and body -- exercising every section, for use as a learning example."
    ),
)
def get_sop_example() -> str:
    ...
    str
        ...
        frontmatter block.
    """
    return read_packaged_text("sop", "example")
