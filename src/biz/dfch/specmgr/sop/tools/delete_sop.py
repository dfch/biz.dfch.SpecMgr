...
@mcp.tool(
    name="delete_sop",
    title="Delete Standard Operating Procedure (not yet implemented)",
...
def delete_sop(id: str) -> NoReturn:
    ...
    NotImplementedError
        Always.
    """
    raise NotImplementedError("delete_sop is not yet implemented")
