...
@mcp.resource(
    ...
    description=(
        "The generated SOP JSON Schema (2020-12 dialect), generated by `specmgr schema` and "
...
def sop_schema() -> dict[str, Any]:
    ...
    """
    result: dict[str, Any] = json.loads(read_packaged_text("sop", "schema", "json"))
    return result
