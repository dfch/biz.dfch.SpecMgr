...
"""Markdown section starting with h2 heading."""
...
@markdown(type="heading_open", tag="h2")
class MarkdownSection2(MarkdownSection):
    ...
    def validate_headings(self) -> MarkdownSection2:
        ...
        """
        # assert self._tokens[0].tag == "h2", f"Expected h2, got {self._tokens[0].tag}"
        # assert not any(
