...
"""Markdown section starting with h3 heading."""
...
@markdown(type="heading_open", tag="h3")
class MarkdownSection3(MarkdownSection):
    ...
    def validate_headings(self) -> MarkdownSection3:
        ...
        """
        # assert self._tokens[0].tag == "h3", f"Expected h3, got {self._tokens[0].tag}"
        # assert not any(
