...
class AdrBody(BaseModel):
    ...
    @field_validator("title", "context_and_problem_statement", "considered_options", "decision_outcome")
    @classmethod
    ...
    @field_validator("decision_drivers", "consequences", "confirmation", "more_information", mode="before")
    @classmethod
