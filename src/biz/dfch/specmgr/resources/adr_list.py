...
from ..tools.adr._io import read_adr
from ..tools.adr._paths import adr_base_dir, iter_adr_paths
...
def adr_list() -> list[AdrSummary]:
    ...
    ``tools.adr._paths.find_adr_path``'s own skip-on-parse-failure rule).
