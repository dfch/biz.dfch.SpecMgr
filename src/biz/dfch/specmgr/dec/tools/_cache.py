...
__all__ = ["invalidate_dec_cache", "read_dec", "reconcile_dec_cache", "reset_dec_cache"]
...
def invalidate_dec_cache(path: Path) -> None:
...
def reconcile_dec_cache(live_paths: Iterable[Path]) -> None:
