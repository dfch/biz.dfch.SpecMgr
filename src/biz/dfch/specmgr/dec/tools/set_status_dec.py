...
from ..models.v1 import DecDocument, DecFrontmatter
...
@mcp.tool(
    ...
    description="The only path that changes a decision's status. Also bumps `updated`.",
)
def set_status_dec(id: str, status: str) -> DecDocument:
