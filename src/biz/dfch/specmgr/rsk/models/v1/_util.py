...
"""Shared, private constants for the ``rsk.models.v1`` subpackage."""

from __future__ import annotations

#: The generated-schema layout version for ``docs/rsk_schema.json``. Matches
#: this package's own folder name (``rsk/models/v1``) -- bump only when a
...
#: ``commands.schema.generate_rsk_schema()`` as the emitted JSON's
...
#: a bare token (``"v1"``, no ``"rsk "`` prefix) -- the doc type is already
