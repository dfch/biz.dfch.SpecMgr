...
- Create `doc/uc-tool-plan.md` (mirroring `doc/adr-tool-plan.md`) with:
...
- This plan closely mirrors `doc/adr-tool-plan.md` in structure and scope — reuse ADR learnings where possible
