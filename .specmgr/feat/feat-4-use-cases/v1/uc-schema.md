...
(`.specmgr/feat/feat-9-doc-in-specmgr/adr-tool-plan.md`), but stays local to `.specmgr/feat/feat-4-use-cases/`
...
(`.specmgr/feat/feat-9-doc-in-specmgr/adr-tool-plan.md` §7 — accepted drift, no validator), the use case
