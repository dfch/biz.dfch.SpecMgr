...
| [`specmgr://ears`](#resource-ears) | The EARS (Easy Approach to Requirements Syntax) five requirement-phrasing templates (Ubiquitous, Event-driven, State-driven, Unwanted behavior, Optional feature) and when to use each, as raw markdown domain-knowledge guidance. |
...
The EARS (Easy Approach to Requirements Syntax) five requirement-phrasing templates (Ubiquitous, Event-driven, State-driven, Unwanted behavior, Optional feature) and when to use each, as raw markdown domain-knowledge guidance.
