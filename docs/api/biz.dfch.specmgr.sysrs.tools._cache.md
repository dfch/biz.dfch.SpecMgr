# `biz.dfch.specmgr.sysrs.tools._cache`
...
### `invalidate_sysrs_cache(path: 'Path') -> 'None'`
...
### `reconcile_sysrs_cache(live_paths: 'Iterable[Path]') -> 'None'`
