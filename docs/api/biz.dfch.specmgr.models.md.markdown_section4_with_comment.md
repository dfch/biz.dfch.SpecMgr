# `biz.dfch.specmgr.models.md.markdown_section4_with_comment`

Opt-in `MarkdownSection4` variant allowing a leading explanatory comment.
...
- `from_text(text: 'str', *, _path: 'str' = '', _offset: 'int' = 0) -> 'MarkdownSection4WithComment'`
  Enforce the >=1-other-field constraint, then defer to `MarkdownSection4.from_text`.

- `get_extent(text: 'str') -> 'int'`
  Enforce the >=1-other-field constraint, then defer to `MarkdownSection4.get_extent`.
...
- `validate_headings(self) -> 'MarkdownSection4'`
