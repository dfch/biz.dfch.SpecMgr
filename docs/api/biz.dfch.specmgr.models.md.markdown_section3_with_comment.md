# `biz.dfch.specmgr.models.md.markdown_section3_with_comment`

Opt-in `MarkdownSection3` variant allowing a leading explanatory comment.
...
- `from_text(text: 'str', *, _path: 'str' = '', _offset: 'int' = 0) -> 'MarkdownSection3WithComment'`
  Enforce the >=1-other-field constraint, then defer to `MarkdownSection3.from_text`.

- `get_extent(text: 'str') -> 'int'`
  Enforce the >=1-other-field constraint, then defer to `MarkdownSection3.get_extent`.
