# `biz.dfch.specmgr.general.tools._similarity_search`
...
### `collect_candidates(provider: 'EmbeddingProvider', candidates: 'Iterator[tuple[str, Path]]') -> 'list[CollectedCandidate]'`
...
### `to_similarity_hit(candidate: 'CollectedCandidate', score: 'float') -> 'SimilarityHit'`
