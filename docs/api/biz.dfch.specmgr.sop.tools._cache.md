# `biz.dfch.specmgr.sop.tools._cache`
...
### `invalidate_sop_cache(path: 'Path') -> 'None'`
...
### `read_sop(path: 'Path') -> 'SopDocument'`
...
### `reconcile_sop_cache(live_paths: 'Iterable[Path]') -> 'None'`
