# `biz.dfch.specmgr.models.md.markdown_section6_with_comment`

Opt-in `MarkdownSection6` variant allowing a leading explanatory comment.
...
- `from_text(text: 'str', *, _path: 'str' = '', _offset: 'int' = 0) -> 'MarkdownSection6WithComment'`
  Enforce the >=1-other-field constraint, then defer to `MarkdownSection6.from_text`.

- `get_extent(text: 'str') -> 'int'`
  Enforce the >=1-other-field constraint, then defer to `MarkdownSection6.get_extent`.
...
- `validate_headings(self) -> 'MarkdownSection6'`
