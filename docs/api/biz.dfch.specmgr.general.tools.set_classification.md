...
### `_set_classification_sysrs(id_: 'str', classification: 'str') -> 'SysrsDocument'`
...
### `set_classification(id: 'str', type: "Literal['req', 'uc', 'tsk', 'qa', 'prb', 'gol', 'rsk', 'dec', 'sop', 'feat', 'vcr', 'sysrs']", classification: 'str') -> '_SetClassificationDocument'`
