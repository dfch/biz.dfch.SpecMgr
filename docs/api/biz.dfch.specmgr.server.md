...
specmgr://ears --       The EARS (Easy Approach to Requirements Syntax) five
                        requirement-phrasing templates (Ubiquitous, Event-driven,
                        State-driven, Unwanted behavior, Optional feature) and when to use
                        each -- raw markdown domain-knowledge guidance.
